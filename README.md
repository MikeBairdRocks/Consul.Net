...
[![CircleCI](https://circleci.com/gh/MikeBairdRocks/Consul.Net.svg?style=svg)](https://circleci.com/gh/MikeBairdRocks/Consul.Net)

* Consul API: [v1.5.2](https://github.com/hashicorp/consul/tree/v0.7.2/api)
* .NET Core: >= 2.0.0
